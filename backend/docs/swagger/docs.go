    ...
    "paths": {
        ...
        "/api/auth/totp/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pending token и код",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.verifyTOTPRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.verifyTOTPResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "api.loginResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "\"totp_required\" | \"totp_setup_required\" | \"ok\"",
                    "type": "string"
                },
                "totp_qr_url": {
                    "type": "string"
